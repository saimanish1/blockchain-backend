...
describe('Transaction', () => {
  ...
  describe('update()', () => {
    let originalSingature, originalSenderOutput, nextRecipient, nextAmount;
    beforeEach(() => {
      originalSingature = transaction.input.signature;
      originalSenderOutput = transaction.outputMap[senderWallet.publicKey];
      nextRecipient = 'next-recipient';
      nextAmount = 50;
      transaction.update({ senderWallet, recipient: nextAmount });
    });
    ...
    it('re-signs the transaction', () => {
      expect(transaction.input.signature).not.toEqual(originalSingature);
    });
  });
});
